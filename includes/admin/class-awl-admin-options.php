    ...
    class AWL_Admin_Options {
        ...
        static public function include_label_settings() {
            ...
            $options['general'][] = array(
                ...
                "spoiler" => array(
                    ...
                    "text"  => '{PRICE} - ' . __( "regular price", "advanced-woo-labels" ) . '<br>' .
                        '{SALE_PRICE} - ' . __( "sale price", "advanced-woo-labels" ) . '<br>' .
                        '{SAVE_PERCENT} - ' . __( "discount percentage", "advanced-woo-labels" ) . '<br>' .
                        '{SAVE_AMOUNT} - ' . __( "discount amount", "advanced-woo-labels" ) . '<br>' .
            ...
            $options['styles'][] = array(
                ...
                'choices' => array(
                    ...
                    'bold' => __( 'Bold', 'advanced-woo-labels' ),
                    'italic' => __( 'Italic', 'advanced-woo-labels' ),
                    'bold_italic' => __( 'Bold italic', 'advanced-woo-labels' ),
                ),
                "class" => "awl-for-text"
            );
        ...
        static public function include_rules() {
            ...
            $options['product'][] = array(
                ...
                "operators" => "equals",
                "choices" => array(
                    'callback' => 'AWL_Admin_Helpers::get_products',
                    'params'   => array()
                ),
            );
