...
if ( ! class_exists( 'AWL_Label_View' ) ) :
    ...
    class AWL_Label_View {
        ...
        public function html() {
            ...
            $html .= '<div class="advanced-woo-labels' . $label_container_classes . '" style="' . $label_container_styles . '">';
            ...
            foreach( $this->labels as $label ) {
                ...
                $html .= $this->label_custom_css();

                $html .= '<div class="awl-label-wrap' . $label_wrap_classes . '" style="' . $label_wrap_styles . '">';

                    $html .= '<span class="awl-product-label' . $label_classes . '" style="' . $label_styles . '">';

                        $html .= $this->label_side_block( 'before' );

                        $html .= $this->label_text();

                        $html .= $this->label_side_block( 'after' );
